...
setup(
    ...
    install_requires=['numba>=0.61','Click>=8.0.0','numpy>=2.0.0,<2.2.0','scipy>=1.13.0','scikit-learn>=1.4.2','statsmodels>=0.14.2','pandas>=2.2.0','biopython>=1.84','pyopenms>=3.3.0','matplotlib>=3.8.4','seaborn>=0.13.2', 'tqdm'],
